export function Footer() {
  return (
    <footer className="bg-gradient-to-r from-background-dark via-gray-900 to-background-dark text-white mt-12 border-t-4 border-primary">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2 text-gray-400">
                ...
                <span>contato@agarramais.com.br</span>
              </div>
              <div className="flex items-start gap-2 text-gray-400">
                <svg
                  className="w-5 h-5 text-primary flex-shrink-0 mt-0.5"
        ...
        <div className="mt-8 pt-6 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              © 2024 Agarra Mais. Todos os direitos reservados. 🧸
            </p>
            <div className="flex items-center gap-4 text-sm text-gray-500">
              <span>Versão 1.0.0</span>
              <span className="w-1 h-1 bg-gray-600 rounded-full"></span>
              <span>Made with Coffe by Gabriel Akira & Mateus Saavedra</span>
            </div>
          </div>
        </div>
      </div>
