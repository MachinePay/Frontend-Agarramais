...
export function Navbar() {
  ...
  return (
    <nav className="bg-linear-to-r from-black via-gray-800 to-gray-900 text-white shadow-2xl border-b-4 border-primary">
          ...
          <div className="flex items-center">
            ...
            >
              <img
                ...
                alt="Agarra Mais"
                className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 object-contain transition-transform duration-300 group-hover:scale-110"
                onError={(e) => {
